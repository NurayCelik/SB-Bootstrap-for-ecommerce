                    ...
                    <form action="" method="POST" enctype="multipart/form-data" data-parsley-validate>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="detail" id="editor1" class="form-control ckeditor" rows="10" required="required"><?php echo $fm->validation($value['detail']); ?></textarea>
                            </div>
                        ...
                        <?php if ($fm->validation($value['isHotProduct']==1)) {
                                                        echo "checked='checked'";
                                                    } else echo ''; ?> 
                        name="isHotProduct" value="<?php echo $fm->validation($value['isHotProduct']); ?>">
                        <label class="form-check-label" for="exampleCheck1">Is Hot Product</label>
                    </div>
                    <div class="form-group form-check">
                        <input type="checkbox" class="form-check-input" id="exampleCheck2" 
                        <?php if ($fm->validation($value['isNewArrival']==1)) {
                                                        echo "checked='checked'";
